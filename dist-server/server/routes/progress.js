...
import { updateLessonProgress, getLessonProgress, getModuleProgressDetailed, generateCertificate, getCertificate, verifyCertificate, getAllUserProgress, getAllLessonProgress, getAllUserCertificates, resetModuleProgress, } from "../api.js";
...
router.post("/lesson", (req, res) => {
    try {
        ...
        updateLessonProgress(userId, moduleId, lessonId, completed, timeSpent, quizScore);
